...
CREATE TABLE `zakaz` (
  ...
  `PickupCode` varchar(100) DEFAULT NULL,
  `login` varchar(100) DEFAULT NULL,
  `code_poluch` varchar(100) DEFAULT NULL,
  `OrderStatus` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`OrderNumber`),
  KEY `PickupCode` (`PickupCode`),
  KEY `login` (`login`),
  CONSTRAINT `zakaz_ibfk_1` FOREIGN KEY (`PickupCode`) REFERENCES `punkt` (`PunktCode`),
  CONSTRAINT `zakaz_ibfk_2` FOREIGN KEY (`login`) REFERENCES `user` (`login`)
